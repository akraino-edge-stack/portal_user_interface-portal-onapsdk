 ...
 */
package org.akraino.portalonapsdk.client.arc;
...
import org.akraino.portalonapsdk.client.arc.resources.EdgeSite;
import org.akraino.portalonapsdk.client.arc.resources.EdgeSites;
import org.akraino.portalonapsdk.client.arc.resources.Hardware;
import org.akraino.portalonapsdk.client.arc.resources.Hardwares;
import org.akraino.portalonapsdk.client.arc.resources.IResource;
...
public final class ArcExecutorClient {
    ...
    public <T extends IResource> T get(@Nonnull Class<T> resource, String id)
