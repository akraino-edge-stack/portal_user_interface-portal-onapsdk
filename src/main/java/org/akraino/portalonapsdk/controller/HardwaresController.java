...
import org.akraino.portalonapsdk.service.HardwaresService;
...
public class HardwaresController extends RestrictedBaseController {
    ...
    public ResponseEntity<Hardwares> getHardwares() {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger,
                    "Error occured when trying to retrieve hardwares. " + UserUtils.getStackTrace(e));
        }
    ...
    public ResponseEntity<Hardware> getHardware(@PathVariable("id") String uuid) {
        try {
            ...
            LOGGER.error(EELFLoggerDelegate.errorLogger,
                    "Error when retrieving Hardware. " + UserUtils.getStackTrace(e));
        }
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(null);
    }
}
